...
static void fail_aes192_enc_test(
  ...
  print_block("key", AES192_ENC_TESTS[num].key); // FIXME
  print_block("exp", exp);
  print_block("got", got);
}
...
static const struct {
  ...
  .iv = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f },
  .src = { 0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11, 0x73, 0x93, 0x17, 0x2a },
  .dst = { 0x4f, 0x02, 0x1d, 0xb2, 0x43, 0xbc, 0x63, 0x3d, 0x71, 0x78, 0x18, 0x3a, 0x9f, 0xa0, 0x71, 0xe8 },
}, {
  .key = { 0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52, 0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79, 0xe5, 0x62, 0xf8, 0xea, 0xd2, 0x52, 0x2c, 0x6b, 0x7b },
  .iv = { 0x4f, 0x02, 0x1d, 0xb2, 0x43, 0xbc, 0x63, 0x3d, 0x71, 0x78, 0x18, 0x3a, 0x9f, 0xa0, 0x71, 0xe8 },
  .src = { 0xae, 0x2d, 0x8a, 0x57, 0x1e, 0x03, 0xac, 0x9c, 0x9e, 0xb7, 0x6f, 0xac, 0x45, 0xaf, 0x8e, 0x51 },
  .dst = { 0xb4, 0xd9, 0xad, 0xa9, 0xad, 0x7d, 0xed, 0xf4, 0xe5, 0xe7, 0x38, 0x76, 0x3f, 0x69, 0x14, 0x5a },
}, {
  .key = { 0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52, 0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79, 0xe5, 0x62, 0xf8, 0xea, 0xd2, 0x52, 0x2c, 0x6b, 0x7b },
  .iv = { 0xb4, 0xd9, 0xad, 0xa9, 0xad, 0x7d, 0xed, 0xf4, 0xe5, 0xe7, 0x38, 0x76, 0x3f, 0x69, 0x14, 0x5a },
  .src = { 0x30, 0xc8, 0x1c, 0x46, 0xa3, 0x5c, 0xe4, 0x11, 0xe5, 0xfb, 0xc1, 0x19, 0x1a, 0x0a, 0x52, 0xef },
  .dst = { 0x57, 0x1b, 0x24, 0x20, 0x12, 0xfb, 0x7a, 0xe0, 0x7f, 0xa9, 0xba, 0xac, 0x3d, 0xf1, 0x02, 0xe0 },
}, {
  .key = { 0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52, 0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79, 0xe5, 0x62, 0xf8, 0xea, 0xd2, 0x52, 0x2c, 0x6b, 0x7b },
  .iv = { 0x57, 0x1b, 0x24, 0x20, 0x12, 0xfb, 0x7a, 0xe0, 0x7f, 0xa9, 0xba, 0xac, 0x3d, 0xf1, 0x02, 0xe0 },
  .src = { 0xf6, 0x9f, 0x24, 0x45, 0xdf, 0x4f, 0x9b, 0x17, 0xad, 0x2b, 0x41, 0x7b, 0xe6, 0x6c, 0x37, 0x10 },
  .dst = { 0x08, 0xb0, 0xe2, 0x79, 0x88, 0x59, 0x88, 0x81, 0xd9, 0x20, 0xa9, 0xe6, 0x4f, 0x56, 0x15, 0xcd },
}};

static void fail_aes192_cbc_enc_test(
  const size_t num,
  const uint8_t got[static 16]
) {
  const uint8_t *exp = AES192_CBC_ENC_TESTS[num].dst;

  printf("FAIL: AES192_CBC_ENC_TESTS[%zu]:\n", num);
  print_block("src", AES192_CBC_ENC_TESTS[num].src);
  print_block("key", AES192_CBC_ENC_TESTS[num].key);
  print_block("exp", exp);
  print_block("got", got);
}

static void test_aes192_cbc_enc(void) {
  for (size_t i = 0; i < LEN(AES192_CBC_ENC_TESTS); i++) {
    // expand key
    pt_aes192_cbc_t state;
    pt_aes192_cbc_init(&state, AES192_CBC_ENC_TESTS[i].key, AES192_CBC_ENC_TESTS[i].iv);

    // encrypt block
    uint8_t got[16];
    pt_aes192_cbc_enc(&state, got, AES192_CBC_ENC_TESTS[i].src);

    // check result
    if (memcmp(got, AES192_CBC_ENC_TESTS[i].dst, 16)) {
      fail_aes192_cbc_enc_test(i, got);
    }
  }
}
...
static const struct {
  ...
  const uint8_t src[16];
  const uint8_t dst[16];
} AES192_CBC_DEC_TESTS[] = {{
  .key = { 0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52, 0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79, 0xe5, 0x62, 0xf8, 0xea, 0xd2, 0x52, 0x2c, 0x6b, 0x7b },
  .iv = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f },
  .src = { 0x4f, 0x02, 0x1d, 0xb2, 0x43, 0xbc, 0x63, 0x3d, 0x71, 0x78, 0x18, 0x3a, 0x9f, 0xa0, 0x71, 0xe8 },
  .dst = { 0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11, 0x73, 0x93, 0x17, 0x2a },
}, {
  .key = { 0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52, 0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79, 0xe5, 0x62, 0xf8, 0xea, 0xd2, 0x52, 0x2c, 0x6b, 0x7b },
  .iv = { 0x4f, 0x02, 0x1d, 0xb2, 0x43, 0xbc, 0x63, 0x3d, 0x71, 0x78, 0x18, 0x3a, 0x9f, 0xa0, 0x71, 0xe8 },
  .src = { 0xb4, 0xd9, 0xad, 0xa9, 0xad, 0x7d, 0xed, 0xf4, 0xe5, 0xe7, 0x38, 0x76, 0x3f, 0x69, 0x14, 0x5a },
  .dst = { 0xae, 0x2d, 0x8a, 0x57, 0x1e, 0x03, 0xac, 0x9c, 0x9e, 0xb7, 0x6f, 0xac, 0x45, 0xaf, 0x8e, 0x51 },
}, {
  .key = { 0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52, 0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79, 0xe5, 0x62, 0xf8, 0xea, 0xd2, 0x52, 0x2c, 0x6b, 0x7b },
  .iv = { 0xb4, 0xd9, 0xad, 0xa9, 0xad, 0x7d, 0xed, 0xf4, 0xe5, 0xe7, 0x38, 0x76, 0x3f, 0x69, 0x14, 0x5a },
  .src = { 0x57, 0x1b, 0x24, 0x20, 0x12, 0xfb, 0x7a, 0xe0, 0x7f, 0xa9, 0xba, 0xac, 0x3d, 0xf1, 0x02, 0xe0 },
  .dst = { 0x30, 0xc8, 0x1c, 0x46, 0xa3, 0x5c, 0xe4, 0x11, 0xe5, 0xfb, 0xc1, 0x19, 0x1a, 0x0a, 0x52, 0xef },
}, {
  .key = { 0x8e, 0x73, 0xb0, 0xf7, 0xda, 0x0e, 0x64, 0x52, 0xc8, 0x10, 0xf3, 0x2b, 0x80, 0x90, 0x79, 0xe5, 0x62, 0xf8, 0xea, 0xd2, 0x52, 0x2c, 0x6b, 0x7b },
  .iv = { 0x57, 0x1b, 0x24, 0x20, 0x12, 0xfb, 0x7a, 0xe0, 0x7f, 0xa9, 0xba, 0xac, 0x3d, 0xf1, 0x02, 0xe0 },
  .src = { 0x08, 0xb0, 0xe2, 0x79, 0x88, 0x59, 0x88, 0x81, 0xd9, 0x20, 0xa9, 0xe6, 0x4f, 0x56, 0x15, 0xcd },
  .dst = { 0xf6, 0x9f, 0x24, 0x45, 0xdf, 0x4f, 0x9b, 0x17, 0xad, 0x2b, 0x41, 0x7b, 0xe6, 0x6c, 0x37, 0x10 },
}};

static void fail_aes192_cbc_dec_test(
  const size_t num,
  const uint8_t got[static 16]
) {
  const uint8_t *exp = AES192_CBC_DEC_TESTS[num].dst;

  printf("FAIL: AES192_CBC_DEC_TESTS[%zu]:\n", num);
  print_block("src", AES192_CBC_DEC_TESTS[num].src);
  print_block("key", AES192_CBC_DEC_TESTS[num].key);
  print_block("exp", exp);
  print_block("got", got);
}

static void test_aes192_cbc_dec(void) {
  for (size_t i = 0; i < LEN(AES192_CBC_DEC_TESTS); i++) {
    // expand key
    pt_aes192_cbc_t state;
    pt_aes192_cbc_init(&state, AES192_CBC_DEC_TESTS[i].key, AES192_CBC_DEC_TESTS[i].iv);

    // decrypt block
    uint8_t got[16];
    pt_aes192_cbc_dec(&state, got, AES192_CBC_DEC_TESTS[i].src);

    // check result
    if (memcmp(got, AES192_CBC_DEC_TESTS[i].dst, 16)) {
      fail_aes192_cbc_dec_test(i, got);
    }
  }
}

// src: NIST FIPS-197, A.3 (page 30)
// https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.197.pdf
static const struct {
  const uint8_t src[32];
  const uint32_t dst[60];
} AES256_KEYEX_TESTS[] = {{
  .src = {
...
static void print_aes256_keyex_key(
  const char * const name,
  const uint8_t src[static 32]
) {
  printf("  %s =\n    ", name);
...
static void print_aes256_keyex_result(
  const char * const name,
  const uint32_t vals[static 60]
) {
  printf("  %s =\n", name);
...
static void fail_aes256_keyex_test(
  const size_t num,
  const uint32_t got[60]
) {
  const uint8_t *src = AES256_KEYEX_TESTS[num].src;
  const uint32_t *exp = AES256_KEYEX_TESTS[num].dst;

  printf("FAIL: AES256_KEYEX_TESTS[%zu]:\n", num);
  print_aes256_keyex_key("src", src);
  print_aes256_keyex_result("exp", exp);
  print_aes256_keyex_result("got", got);
}

static void test_aes256_keyex(void) {
  for (size_t i = 0; i < LEN(AES256_KEYEX_TESTS); i++) {
    // expand key
    uint32_t got[60];
    pt_aes256_keyex(got, AES256_KEYEX_TESTS[i].src);

    // check result
    if (memcmp(got, AES256_KEYEX_TESTS[i].dst, 60 * sizeof(uint32_t))) {
      fail_aes256_keyex_test(i, got);
    }
  }
}
...
static void fail_aes256_enc_test(
  ...
  print_block("key", AES256_ENC_TESTS[num].key); // FIXME
  print_block("exp", exp);
  print_block("got", got);
}
...
static void fail_aes256_dec_test(
  const size_t num,
  const uint8_t got[static 16]
) {
  const uint8_t *exp = AES256_DEC_TESTS[num].dst;

  printf("FAIL: AES256_DEC_TESTS[%zu]:\n", num);
  print_block("src", AES256_DEC_TESTS[num].src);
  print_block("key", AES256_DEC_TESTS[num].key); // FIXME
  print_block("exp", exp);
  print_block("got", got);
}

static void test_aes256_dec(void) {
  for (size_t i = 0; i < LEN(AES256_DEC_TESTS); i++) {
    // expand key
    uint32_t key_data[44];
    pt_aes256_keyex(key_data, AES256_DEC_TESTS[i].key);

    // decrypt block
    uint8_t got[16];
    pt_aes256_dec(got, AES256_DEC_TESTS[i].src, key_data);

    // check result
    if (memcmp(got, AES256_DEC_TESTS[i].dst, 16)) {
      fail_aes256_dec_test(i, got);
    }
  }
}

// aes256-cbc enc tests
// src: https://github.com/ircmaxell/quality-checker/blob/master/tmp/gh_18/PHP-PasswordLib-master/test/Data/Vectors/aes-cbc.test-vectors
static const struct {
  const uint8_t key[32];
  const uint8_t iv[16];
  ...
  .iv = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f },
  .src = { 0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11, 0x73, 0x93, 0x17, 0x2a },
  .dst = { 0xf5, 0x8c, 0x4c, 0x04, 0xd6, 0xe5, 0xf1, 0xba, 0x77, 0x9e, 0xab, 0xfb, 0x5f, 0x7b, 0xfb, 0xd6 },
}, {
  .key = { 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d, 0x77, 0x81, 0x1f, 0x35, 0x2c, 0x07, 0x3b, 0x61, 0x08, 0xd7, 0x2d, 0x98, 0x10, 0xa3, 0x09, 0x14, 0xdf, 0xf4 },
  .iv = { 0xf5, 0x8c, 0x4c, 0x04, 0xd6, 0xe5, 0xf1, 0xba, 0x77, 0x9e, 0xab, 0xfb, 0x5f, 0x7b, 0xfb, 0xd6 },
  .src = { 0xae, 0x2d, 0x8a, 0x57, 0x1e, 0x03, 0xac, 0x9c, 0x9e, 0xb7, 0x6f, 0xac, 0x45, 0xaf, 0x8e, 0x51 },
  .dst = { 0x9c, 0xfc, 0x4e, 0x96, 0x7e, 0xdb, 0x80, 0x8d, 0x67, 0x9f, 0x77, 0x7b, 0xc6, 0x70, 0x2c, 0x7d },
}, {
  .key = { 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d, 0x77, 0x81, 0x1f, 0x35, 0x2c, 0x07, 0x3b, 0x61, 0x08, 0xd7, 0x2d, 0x98, 0x10, 0xa3, 0x09, 0x14, 0xdf, 0xf4 },
  .iv = { 0x9c, 0xfc, 0x4e, 0x96, 0x7e, 0xdb, 0x80, 0x8d, 0x67, 0x9f, 0x77, 0x7b, 0xc6, 0x70, 0x2c, 0x7d },
  .src = { 0x30, 0xc8, 0x1c, 0x46, 0xa3, 0x5c, 0xe4, 0x11, 0xe5, 0xfb, 0xc1, 0x19, 0x1a, 0x0a, 0x52, 0xef },
  .dst = { 0x39, 0xf2, 0x33, 0x69, 0xa9, 0xd9, 0xba, 0xcf, 0xa5, 0x30, 0xe2, 0x63, 0x04, 0x23, 0x14, 0x61 },
}, {
  .key = { 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d, 0x77, 0x81, 0x1f, 0x35, 0x2c, 0x07, 0x3b, 0x61, 0x08, 0xd7, 0x2d, 0x98, 0x10, 0xa3, 0x09, 0x14, 0xdf, 0xf4 },
  .iv = { 0x39, 0xF2, 0x33, 0x69, 0xA9, 0xD9, 0xBA, 0xCF, 0xA5, 0x30, 0xE2, 0x63, 0x04, 0x23, 0x14, 0x61 },
  .src = { 0xf6, 0x9f, 0x24, 0x45, 0xdf, 0x4f, 0x9b, 0x17, 0xad, 0x2b, 0x41, 0x7b, 0xe6, 0x6c, 0x37, 0x10 },
  .dst = { 0xb2, 0xeb, 0x05, 0xe2, 0xc3, 0x9b, 0xe9, 0xfc, 0xda, 0x6c, 0x19, 0x07, 0x8c, 0x6a, 0x9d, 0x1b },
}};

static void fail_aes256_cbc_enc_test(
  const size_t num,
  const uint8_t got[static 16]
) {
  const uint8_t *exp = AES256_CBC_ENC_TESTS[num].dst;

  printf("FAIL: AES256_CBC_ENC_TESTS[%zu]:\n", num);
  print_block("src", AES256_CBC_ENC_TESTS[num].src);
  print_block("key", AES256_CBC_ENC_TESTS[num].key); // FIXME
  print_block("exp", exp);
  print_block("got", got);
}

static void test_aes256_cbc_enc(void) {
  for (size_t i = 0; i < LEN(AES256_CBC_ENC_TESTS); i++) {
    // expand key
    pt_aes256_cbc_t state;
    pt_aes256_cbc_init(&state, AES256_CBC_ENC_TESTS[i].key, AES256_CBC_ENC_TESTS[i].iv);

    // encrypt block
    uint8_t got[16];
    pt_aes256_cbc_enc(&state, got, AES256_CBC_ENC_TESTS[i].src);

    // check result
    if (memcmp(got, AES256_CBC_ENC_TESTS[i].dst, 16)) {
      fail_aes256_cbc_enc_test(i, got);
    }
  }
}

// aes256-cbc dec tests
// src: https://github.com/ircmaxell/quality-checker/blob/master/tmp/gh_18/PHP-PasswordLib-master/test/Data/Vectors/aes-cbc.test-vectors
static const struct {
  const uint8_t key[32];
  const uint8_t iv[16];
  const uint8_t src[16];
  const uint8_t dst[16];
} AES256_CBC_DEC_TESTS[] = {{
  .key = { 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d, 0x77, 0x81, 0x1f, 0x35, 0x2c, 0x07, 0x3b, 0x61, 0x08, 0xd7, 0x2d, 0x98, 0x10, 0xa3, 0x09, 0x14, 0xdf, 0xf4 },
  .iv = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f },
  .src = { 0xf5, 0x8c, 0x4c, 0x04, 0xd6, 0xe5, 0xf1, 0xba, 0x77, 0x9e, 0xab, 0xfb, 0x5f, 0x7b, 0xfb, 0xd6 },
  .dst = { 0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11, 0x73, 0x93, 0x17, 0x2a },
}, {
  .key = { 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d, 0x77, 0x81, 0x1f, 0x35, 0x2c, 0x07, 0x3b, 0x61, 0x08, 0xd7, 0x2d, 0x98, 0x10, 0xa3, 0x09, 0x14, 0xdf, 0xf4 },
  .iv = { 0xf5, 0x8c, 0x4c, 0x04, 0xd6, 0xe5, 0xf1, 0xba, 0x77, 0x9e, 0xab, 0xfb, 0x5f, 0x7b, 0xfb, 0xd6 },
  .src = { 0x9c, 0xfc, 0x4e, 0x96, 0x7e, 0xdb, 0x80, 0x8d, 0x67, 0x9f, 0x77, 0x7b, 0xc6, 0x70, 0x2c, 0x7d },
  .dst = { 0xae, 0x2d, 0x8a, 0x57, 0x1e, 0x03, 0xac, 0x9c, 0x9e, 0xb7, 0x6f, 0xac, 0x45, 0xaf, 0x8e, 0x51 },
}, {
  .key = { 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d, 0x77, 0x81, 0x1f, 0x35, 0x2c, 0x07, 0x3b, 0x61, 0x08, 0xd7, 0x2d, 0x98, 0x10, 0xa3, 0x09, 0x14, 0xdf, 0xf4 },
  .iv = { 0x9c, 0xfc, 0x4e, 0x96, 0x7e, 0xdb, 0x80, 0x8d, 0x67, 0x9f, 0x77, 0x7b, 0xc6, 0x70, 0x2c, 0x7d },
  .src = { 0x39, 0xf2, 0x33, 0x69, 0xa9, 0xd9, 0xba, 0xcf, 0xa5, 0x30, 0xe2, 0x63, 0x04, 0x23, 0x14, 0x61 },
  .dst = { 0x30, 0xc8, 0x1c, 0x46, 0xa3, 0x5c, 0xe4, 0x11, 0xe5, 0xfb, 0xc1, 0x19, 0x1a, 0x0a, 0x52, 0xef },
}, {
  .key = { 0x60, 0x3d, 0xeb, 0x10, 0x15, 0xca, 0x71, 0xbe, 0x2b, 0x73, 0xae, 0xf0, 0x85, 0x7d, 0x77, 0x81, 0x1f, 0x35, 0x2c, 0x07, 0x3b, 0x61, 0x08, 0xd7, 0x2d, 0x98, 0x10, 0xa3, 0x09, 0x14, 0xdf, 0xf4 },
  .iv = { 0x39, 0xF2, 0x33, 0x69, 0xA9, 0xD9, 0xBA, 0xCF, 0xA5, 0x30, 0xE2, 0x63, 0x04, 0x23, 0x14, 0x61 },
  .src = { 0xb2, 0xeb, 0x05, 0xe2, 0xc3, 0x9b, 0xe9, 0xfc, 0xda, 0x6c, 0x19, 0x07, 0x8c, 0x6a, 0x9d, 0x1b },
  .dst = { 0xf6, 0x9f, 0x24, 0x45, 0xdf, 0x4f, 0x9b, 0x17, 0xad, 0x2b, 0x41, 0x7b, 0xe6, 0x6c, 0x37, 0x10 },
}};

static void fail_aes256_cbc_dec_test(
  const size_t num,
  const uint8_t got[static 16]
) {
  const uint8_t *exp = AES256_CBC_DEC_TESTS[num].dst;

  printf("FAIL: AES256_CBC_DEC_TESTS[%zu]:\n", num);
  print_block("src", AES256_CBC_DEC_TESTS[num].src);
  print_block("key", AES256_CBC_DEC_TESTS[num].key); // FIXME
  print_block("exp", exp);
  print_block("got", got);
}

static void test_aes256_cbc_dec(void) {
  for (size_t i = 0; i < LEN(AES256_CBC_DEC_TESTS); i++) {
    // expand key
    pt_aes256_cbc_t state;
    pt_aes256_cbc_init(&state, AES256_CBC_DEC_TESTS[i].key, AES256_CBC_DEC_TESTS[i].iv);

    // encrypt block
    uint8_t got[16];
    pt_aes256_cbc_dec(&state, got, AES256_CBC_DEC_TESTS[i].src);

    // check result
    if (memcmp(got, AES256_CBC_DEC_TESTS[i].dst, 16)) {
      fail_aes256_cbc_dec_test(i, got);
    }
  }
}
